...
$server = 'ktoolan.rhody.dev';                    // Server the database is on
$db       = 'ktoolan_toystore';     // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'ktoolan';     // Enter YOUR cPanel username and user here
$password = 'UI1qHc0Rt3wyHEPXY-4';           // Enter YOUR user password here
